...
describe Salesforce::OAuth do
  it 'Pass the client_id null' do
    expect do
      Salesforce::OAuth.new(client_id: nil, client_secret: CLIENT_SECRET, username: USERNAME, password: PASSWORD, security_token: SECURITY_TOKEN)
  ...
  it 'Pass the client_secret null' do
    expect do
      Salesforce::OAuth.new(client_id: CLIENT_ID, client_secret: nil, username: USERNAME, password: PASSWORD, security_token: SECURITY_TOKEN)
  ...
  it 'Pass the username null' do
    expect do
      Salesforce::OAuth.new(client_id: CLIENT_ID, client_secret: CLIENT_SECRET, username: nil, password: PASSWORD, security_token: SECURITY_TOKEN)
  ...
  it 'Pass the password null' do
    expect do
      Salesforce::OAuth.new(client_id: CLIENT_ID, client_secret: CLIENT_SECRET, username: USERNAME, password: nil, security_token: SECURITY_TOKEN)
  ...
  it 'Pass the security_token null' do
    expect do
      Salesforce::OAuth.new(client_id: CLIENT_ID, client_secret: CLIENT_SECRET, username: USERNAME, password: PASSWORD, security_token: nil)
  ...
  it 'Call method call' do
    expect(Salesforce::OAuth.new(client_id: CLIENT_ID, client_secret: CLIENT_SECRET, username: USERNAME, password: PASSWORD, security_token: SECURITY_TOKEN).call).to be_nil
  end
