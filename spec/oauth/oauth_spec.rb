...
describe Salesforce::OAuth do
  it 'Pass the client_id null' do
    expect do
      Salesforce::OAuth.new(nil, CLIENT_SECRET, USERNAME, PASSWORD, SECURITY_TOKEN,
                            API_VERSION)
  ...
  it 'Pass the client_secret null' do
    expect do
      Salesforce::OAuth.new(CLIENT_ID, nil, USERNAME, PASSWORD, SECURITY_TOKEN,
                            API_VERSION)
  ...
  it 'Pass the username null' do
    expect do
      Salesforce::OAuth.new(CLIENT_ID, CLIENT_SECRET, nil, PASSWORD, SECURITY_TOKEN,
                            API_VERSION)
  ...
  it 'Pass the password null' do
    expect do
      Salesforce::OAuth.new(CLIENT_ID, CLIENT_SECRET, USERNAME, nil, SECURITY_TOKEN,
                            API_VERSION)
  ...
  it 'Pass the security_token null' do
    expect do
      Salesforce::OAuth.new(CLIENT_ID, CLIENT_SECRET, USERNAME, PASSWORD, nil,
                            API_VERSION)
  ...
  it 'Pass the api_version null' do
    expect do
      Salesforce::OAuth.new(CLIENT_ID, CLIENT_SECRET, USERNAME, PASSWORD, SECURITY_TOKEN,
                            nil)
